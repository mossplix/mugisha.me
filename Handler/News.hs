...
getNewsFeedR = do
    ...
    newsFeed Feed
       { feedTitle = "mugisha.me"
       , feedAuthor = "Moses Mugisha"
       , feedLinkSelf = NewsFeedR
       , feedLinkHome = RootR
       , feedDescription = "RSS/Atom Feed Moses Mugisha"
       , feedLanguage = "en"
...
getCommentFeedR key = do
    ...
    newsFeed Feed
       { feedTitle = "Comments for entry '" `mappend` (entryTitle e) `mappend` "' on mugisha.me"
       , feedAuthor = "…"
